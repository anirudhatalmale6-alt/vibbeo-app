...
class ZegoTokenUtils {
  static String generateToken(int appid, String serverSecret, String userID, {int effectiveTimeInSeconds = 60 * 60 * 24, String payload = ''}) {
    debugPrint('! ${'*' * 80}');
    debugPrint('! ** Warning: ZegoTokenUtils is only for use during testing. When your application goes live,');
    debugPrint('! ** tokens must be generated by the server side. Please do not generate tokens on the client side!');
    debugPrint('! ${'*' * 80}');
    if (appid == 0) {
...
class TokenInfo04 {
  TokenInfo04({required this.appid, required this.userID, required this.ctime, required this.expire, required this.nonce, required this.payload});
